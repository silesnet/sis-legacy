...
public interface BillingManager {
    ...
    /**
     * Generate bills that are to be issued due to given date.
     * Bills are not persisted, they need to be confirmed first.
     *
     * @param due due date.
     * @param numbering 
     * @return list of bills that are applicable due given date. Bill
     * includes periodical and one-time services as bill items.
     */
    public List<Bill> generateAll(Invoicing invoicing, List<Customer> customers, Date due, String numbering);
    ...
    /**
     * Confirms delivery of bill acording to unique bill hashcode.
     * Hashcode is part of link sent by email to customer.
     *
