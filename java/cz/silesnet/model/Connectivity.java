...
public class Connectivity
    ...
    private Integer fAggregationId;
     ...
     * @param id
     */
    public Connectivity(Integer download, Integer upload, Boolean aggregated,
        Integer id) {
		this();
        fDownload          = download;
        fUpload            = upload;
    ...
    public String getHistoricToString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append(getDownload())
                                                                        .append(getUpload())
                                                                        .append(getIsAggregated())
