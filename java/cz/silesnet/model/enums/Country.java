...
public enum Country implements EnumPersistenceMapping<Country> {
	CZ	(10, "enum.country.cz", "cs"),
	PL	(20, "enum.country.pl", "pl"),
	SK	(30, "enum.country.sk", "sk");

	private int fId;
	private String fName;
	private Locale locale;
	// has to declare it by hand
	private static ReverseEnumMap<Country> sReverseMap = new ReverseEnumMap<Country>(Country.class);
