...
public enum Polarization implements EnumPersistenceMapping<Polarization> {
	HORIZONTAL (10, "enum.polarization.horizontal"),
	VERTICAL   (20, "enum.polarization.vertical");
	
	private int id;
	private String name;
	// has to declare it by hand
	private static ReverseEnumMap<Polarization> reverseMap = new ReverseEnumMap<Polarization>(Polarization.class);
