...
public class NavigationFilter
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        Stack<String> urlStack = (Stack<String>) WebUtils.getSessionAttribute(request,
                "_navUrlStack");
        ...
        if ((urlQuery != null) && (urlQuery.contains("_navPushUrl"))) {
            ...
            if (cleanUrl.equals(prevUrl))
                ...
                log.debug(
                    "REPEATED _navPushUrl by some form controller dropping it!!!");
            else {
                // legal push, let's do it
                log.debug(
                    "_navPushUrl parameter found in request, so pushing previous url to stack...");
...
//        chain.doFilter(new HttpRequestWrapper(request), new HttpResponseWrapper((HttpServletResponse) res));
    }
