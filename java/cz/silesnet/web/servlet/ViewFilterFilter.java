...
//        Map<String, String> reqFilterParamsMap = FilterUtils.getParamMap(request, "_filter");
        Map<String, String> reqFilterParamsMap = WebUtils.getParametersStartingWith(request, "_filter.");
