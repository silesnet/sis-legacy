...
/**
 * Custom editor used for binding Enum values of enum classes
 * that implement EnumPersistenceMapping interface.
 * 
 * @author Richard Sikora
 */
public class CustomEnumEditor<E extends Enum<E> & EnumPersistenceMapping<E>> extends PropertyEditorSupport {
