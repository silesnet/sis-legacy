...
public class MessagesUtils
    ...
    public static void setCodedSuccessMessage(HttpServletRequest request,
        ...
        setPlainResultMessage(request, "successMsg",
            getMessage(key, args, request.getLocale()));
    }
    ...
    public static void setCodedSuccessMessage(HttpServletRequest request,
        String key) {
        setPlainResultMessage(request, "successMsg", getMessage(key, request.getLocale()));
    }


    public static void setCodedFailureMessage(HttpServletRequest request,
            String key, Object[] args) {
            setPlainResultMessage(request, "failureMsg",
                getMessage(key, args, request.getLocale()));
    }
    ...
    public static void setCodedFailureMessage(HttpServletRequest request,
        String key) {
        setPlainResultMessage(request, "failureMsg", getMessage(key, request.getLocale()));
    }
