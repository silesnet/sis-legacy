...
public class CustomerManagerTest extends BaseServiceTestCase {
    ...
    public void testCRUD() {
        ...
        // FIXME see if history is growing
        // it does not work perhaps due to strange transactions policy during the tests
        log.debug("History size: " + hmgr.getHistory(c).size() + ", expected more than: " + historySize);
