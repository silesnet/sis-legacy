...
public class SearchUtils {
  ...
  // private static String sFromChars =
  // "e��������ͣ����؊�?���ݎ?����������������?����.-,;:&+ ";
  // private static String sFromChars =
  // "�?�???�??��???��?�??�?�ݎ??�?�???�??��???��?�??�?��??.-,;:&+ ";
  ...
  public static String getTranslateColumn(String arg) {
    return "lower(translate(" + arg + ",'" + getFromChars() + "','"
        + getToChars() + "'))";
  }

  public static String translate(String s) {
    return StringUtils.replaceChars(s, getFromChars(), getToChars())
        .toLowerCase();
  }

  public static String getTranslateOrder(String col) {
    return "translate(" + col + ",'" + getFromChars() + "','"
        + getToChars() + "')";
  }
  ...
  public static void addIlikeRestriction(DetachedCriteria crit, String col,
                                         String value) {
    if (value != null)
      crit.add(Restrictions.sqlRestriction("lower(" + col + ") like('" + value.toLowerCase()
          + "%')"));
  }
  ...
  public static void addIlikeRestrictionI18n(DetachedCriteria crit,
                                             String col, String value) {
    if (value != null)
      addIlikeRestriction(crit, getTranslateColumn(col), translate(value));
  }

  public static void addIlikeInRestrictionI18n(DetachedCriteria crit,
                                               String col, String value) {
    if (value != null)
      addIlikeInRestriction(crit, getTranslateColumn(col),
          translate(value));
  }

  public static void addEqRestriction(DetachedCriteria crit, String col,
                                      Object value) {
    if (value != null) {
  ...
  public static void addEqRestriction(DetachedCriteria crit, String col,
                                      EnumPersistenceMapping<?> enumerator) {
    if (enumerator != null) {
      crit.add(Restrictions
          .sqlRestriction(col + "=" + enumerator.getId()));
    }
  }
