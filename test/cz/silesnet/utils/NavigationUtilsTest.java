...
public class NavigationUtilsTest
    ...
    public void testRemoveSystemParameters() {
        ...
        assertTrue("#fido".equals(NavigationUtils.removeSystemParameters(query)));

        query = "param=value+value1&_param=value2";
        assertTrue("param=value+value1".equals(
                NavigationUtils.removeSystemParameters(query)));

        query = "param=value+value1&_param=value2#fido";
        assertTrue("param=value+value1#fido".equals(
                NavigationUtils.removeSystemParameters(query)));

        query = "param=value+value1&_param=value2&param2=value3";
        assertTrue("param=value+value1&param2=value3".equals(
                NavigationUtils.removeSystemParameters(query)));

        query = "param=value+value1&_param=value2&param2=value3#fido";
        assertTrue("param=value+value1&param2=value3#fido".equals(
                NavigationUtils.removeSystemParameters(query)));
